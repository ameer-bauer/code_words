...
parser.add_argument("-q", action='store_true', help="QUITE MODE: Only display the generated code word(s).")
...
if args.h:
    ...
    print('  -q Displays only the generated code word(s), without any additional information.\n')
